...
def CalTransmission(HazeImg, Transmission, regularize_lambda, sigma):
    ...
    while(beta < beta_max):
        ...
        # Fixing u and solving t --> Equation 19 in the report
        # Note: In equation 19, the Numerator is the "DU" calculated in the above part of the code
        # In the equation 19, the Denominator is the DS which was computed as a constant in the above code
...
def CalculateWeightingFunction(HazeImg, Filter, sigma):
    ...
    # Computing the weight function... Eq (10) in the report
